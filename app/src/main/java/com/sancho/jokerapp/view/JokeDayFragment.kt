package com.sancho.jokerapp.view
...
import com.sancho.jokerapp.R
import com.sancho.jokerapp.model.Joke
import com.sancho.jokerapp.presentation.JokeDayPresenter
...
class JokeDayFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imageView = view.findViewById(R.id.joke_of_the_day_logo)
